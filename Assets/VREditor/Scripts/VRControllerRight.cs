namespace VRTK.Examples
{
    ...
    public class VRControllerRight: MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (StateManager.Instance.editMode == 0)
            {
        ...
        public void updateThumbnail(GameObject go)
        {
            ...
            Destroy(StateManager.Instance.displayThumbnailControlledObject.GetComponent<ObjectIdentifier>());
        ...
        private void DoTouchpadPressed(object sender, ControllerInteractionEventArgs e)
        {
            ...
            if (StateManager.Instance.editMode == 4) // instantiate
            {
                ...
                ObjectIdentifier obj = StateManager.Instance.controlledObject.GetComponent<ObjectIdentifier>();
                obj.id = ""; // set to nothing so it can be saved
                Vector3 center = rend.bounds.center;
                float radius = rend.bounds.extents.magnitude;
